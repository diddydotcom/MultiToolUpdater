...
Bl = '\033[30m'  
Re = '\033[1;31m'
Gr = '\033[0;37m'  # Changed from green to silver (light grey)
Ye = '\033[1;33m'
Blu = '\033[1;34m'
Mage = '\033[1;35m'
Cy = '\033[1;36m'
...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Gr}Ex [+1463xxxxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
    default_region = "ID"  
...
def option():
  ...
  _______          _____       _            
 |__   __|        / ____|     (_)           
    | |_ __ _   _| (___  _ __  _ _ __   ___ 
    | | '__| | | |\___ \| '_ \| | '_ \ / _ \
    | | |  | |_| |____) | | | | | |_) |  __/
    |_|_|   \__,_|_____/|_| |_|_| .__/ \___|
                                | |         
                                |_|          
        [ + ]  TruSnipe - OSINT Tracker Toolkit [ + ]
""")
